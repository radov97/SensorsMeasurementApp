// The content of this class has been taken from another project written by someone else.
// It has simply been adapted to the needs of this project.
...
public class DynamicAccelerometerPlot
{
    ...
    public DynamicAccelerometerPlot(XYPlot plot, Context context, String title)
    {
        this.plot = plot;
    ...
    private void initPlot()
    {
        ...
        this.plot.setRangeStep(XYStepMode.INCREMENT_BY_VAL, 5);
