...
public class DynamicMagnetometerPlot
{
    ...
    public DynamicMagnetometerPlot(XYPlot plot, Context context, String title)
    {
        this.plot = plot;
    ...
    private void initPlot()
    {
        ...
        this.plot.setRangeStep(XYStepMode.INCREMENT_BY_VAL, 100);
